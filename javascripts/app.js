...
{% include javascripts/annotations.js %}
...
(function () {
  ...
  Choosealicense = function () {
    ...
    Choosealicense.prototype.initZeroClipboard = function () {
      ...
      clip = new ZeroClipboard($(".js-clipboard-button"), { moviePath: "/javascripts/ZeroClipboard.swf" });
    ...
    Choosealicense.prototype.clipboardMouseout = function() {
